...
interface LoginAttemptsListProps {
	initialData: LoginAttemptItem[];
}
					...
					<table className="w-full text-left text-sm">
						<thead className="bg-gray-50 border-b border-gray-100">
							<tr>
								...
								<th className="px-6 py-3 font-semibold text-gray-900">Identifier</th>
								<th className="px-6 py-3 font-semibold text-gray-900 text-center">Attempts</th>
								<th className="px-6 py-3 font-semibold text-gray-900">Status</th>
								<th className="px-6 py-3 font-semibold text-gray-900">First Attempt</th>
								<th className="px-6 py-3 font-semibold text-gray-900">Locked Until</th>
							</tr>
						</thead>
