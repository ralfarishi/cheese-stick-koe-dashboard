				...
				<div className="mb-8">
					...
					<div className="block md:hidden mb-4">
						<nav className="flex items-center gap-2 text-sm mt-6">
							...
							<span className="text-[#8B2E1F] font-semibold">Update Invoice</span>
						</nav>
					</div>
					...
					<div className="bg-gradient-to-r from-[#8B2E1F] to-[#A63825] rounded-2xl p-6 md:p-8 shadow-xl">
						<div className="flex items-center gap-4">
							...
							<div>
								<h1 className="text-3xl md:text-4xl font-bold text-white">Update Invoice</h1>
							...
							<div className="p-6">
								<div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
									{items.map((item, index) => (
										<div
											key={index}
											className="group relative bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 hover:border-[#8B2E1F] rounded-2xl p-5 transition-all duration-300 hover:shadow-xl md:animate-item-enter"
										>
											{/* Item Header */}
