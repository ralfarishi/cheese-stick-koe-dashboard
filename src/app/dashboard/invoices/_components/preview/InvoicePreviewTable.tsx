...
import type { PreviewItem } from "../../_hooks/useInvoicePreviewData";
...
function TableHeader({ hasDiscount }: TableHeaderProps) {
	return (
...
function TableRow({ item, index, hasDiscount }: TableRowProps) {
	return (
		<tr
...
function SummaryFooter({ subtotal, invoice, discountPercent, shippingType }: SummaryFooterProps) {
	return (
		<div
